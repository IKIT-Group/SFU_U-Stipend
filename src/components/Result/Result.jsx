    ...
    >
      ...
      >
        <li className={styles.resultItem}>
          <span className={styles.resultName}>Государственная Академическая Стипендия</span>
          <span className={styles.resultAmount}>1900Р</span>
          <span className={styles.resultStatus}><SuccessIcon className={styles.resultStatus} /></span>
        </li>
        <li className={styles.resultItem}>
          <span className={styles.resultName}>Повышенная Государственная Академическая стипендия</span>
        ...
        <li className={styles.resultItem}>
          <span className={styles.resultName}>Стипендия для студентов платной основы от ППОС СФУ</span>
          <span className={styles.resultAmount}></span>
          <span className={styles.resultStatus}></span>
        </li>
      </ul>
