  ...
  return (<aside
    ...
    >
      <div
        ...
        className={clsx(styles.resultPlaceholder, 'visually-hidden')}
        data-js-result-placeholder
      >
        Введите данные для расчета стипендии...
      </div>
      <div
        className={clsx(styles.resultTitles, styles.resultBlock)}
        data-js-result-titles
      >
      ...
      >
        ...
        >
                  ...
                  >Государственная Академическая Стипендия</span
                  >
          <span className={styles.resultAmount}></span>
          <span className={styles.resultStatus}></span>
        </li>
        <li className={styles.resultItem}>
                  <span
                    className={styles.resultName}
                  >Повышенная Государственная Академическая стипендия</span
                  >
          <span className={styles.resultAmount}></span>
          <span className={styles.resultStatus}></span>
        </li>
        <li className={styles.resultItem}>
          <span className={styles.resultName}>Социальная стипендия</span>
          <span className={styles.resultAmount}></span>
          <span className={styles.resultStatus}></span>
        </li>
        <li className={styles.resultItem}>
          <span className={styles.resultName}>Краевая выплата</span>
          <span className={styles.resultAmount}></span>
          <span className={styles.resultStatus}></span>
        </li>
        <li className={styles.resultItem}>
          <span className={styles.resultName}>Стипендия Правительства РФ</span>
          <span className={styles.resultAmount}></span>
          <span className={styles.resultStatus}></span>
        </li>
        <li className={styles.resultItem}>
          <span className={styles.resultName}>Стипендия Президента РФ</span>
          <span className={styles.resultAmount}></span>
          <span className={styles.resultStatus}></span>
        </li>
        <li className={styles.resultItem}>
                  <span
                    className={styles.resultName}
                  >Стипендия для студентов платной основы от ППОС СФУ</span
                  >
          <span className={styles.resultAmount}></span>
          <span className={styles.resultStatus}></span>
        </li>
      ...
      <div
        className={clsx(styles.resultOutput, styles.resultBlock)}
        data-js-result-output
      >
        <div className={styles.resultTotal}>
                  <span
                    className={styles.resultTotalText}
                  >Гарантированная сумма стипендии</span
                  >
          <span className={styles.resultTotalAmount}></span>
        </div>
        <div className={styles.resultTotal}>
                  <span
                    className={styles.resultTotalText}
                  >Возможна сумма стипендии</span
                  >
          <span className={styles.resultPossibleAmount}></span>
        </div>
